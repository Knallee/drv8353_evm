...
// LOSPCP prescale register settings, normally it will be set to default values
   ...
   //GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 3;  // GPIO18 = XCLKOUT  <======== Can't use it, SPIA use this io
   SysCtrlRegs.LOSPCP.all = 0x0002;     // Low speed clock= SYSCLKOUT/4 (reset default)

// XCLKOUT to SYSCLKOUT ratio.  By default XCLKOUT = 1/4 SYSCLKOUT
   //SysCtrlRegs.XCLK.bit.XCLKOUTDIV=2; // Set XCLKOUT = SYSCLKOUT/1 <======== Can't use it, SPIA use this io
